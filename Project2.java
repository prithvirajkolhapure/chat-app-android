...
public class Project2 {
    ...
    public Project2(long id, String korisnickoIme, String avatar, String tekstProuke) {
        this.id            = id;
    ...
    public long citanjeId() { return id; }
    public void azuriranjeId(long id) { this.id = id; }

    public String citanjeVreme() {
        return milisekundeUDatumFormat(id,"dd.MM.yyyy.\n     HH:mm:ss");
    }

    public String citanjeKorisnickoIme() { return korisnickoIme; }
    public void azuriranjeKorisnickoIme(String korisnickoIme) { this.korisnickoIme = korisnickoIme; }

    public String citanjeAvatar() { return avatar; }
    public void azuriranjeAvatar(String avatar) { this.avatar = avatar; }

    public String citanjeTekstProuke() { return tekstProuke; }
    public void azuriranjeTekstProuke(String tekstProuke) { this.tekstProuke = tekstProuke; }
}
